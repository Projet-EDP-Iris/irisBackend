...
def get_current_active_user(
    ...
    """
    Dependency for all standard protected endpoints.
    Requires a valid JWT — email verification is NOT required.
    Users can explore the app before verifying their email address.
    """
    return current_user
...
def get_verified_user(
    ...
    """
    Stricter dependency reserved for sensitive actions (password change, account deletion).
    Requires both a valid JWT AND a verified email address.
    """
